...
{
	//SgLNode* n1 = (SgLNode*)malloc(sizeof(SgLNode));			//每个结点的结构体空间开辟
	//assert(n1);
	//SgLNode* n2 = (SgLNode*)malloc(sizeof(SgLNode));
	//assert(n2);
	//SgLNode* n3 = (SgLNode*)malloc(sizeof(SgLNode));
	//assert(n3);
	//SgLNode* n4 = (SgLNode*)malloc(sizeof(SgLNode));
	//assert(n4);
...
void SingleList_Test3_PUSHFRONT()
{
	...
	n1 = SGLPushFront1(n1, 1);
	n1 = SGLPushFront1(n1, 2);
	n1 = SGLPushFront1(n1, 3);
	n1 = SGLPushFront1(n1, 4);
	//观察结果
	SGLPrint(n1);
